        ...
        <Wrapper>
            <View>
                    ...
                    {({
                        ...
                        <View>
                            ...
                            <TouchableOpacity style={styles.textFPContainer}>
                                <Text style={styles.textFP}>{t('fgPw')} ?</Text>
                            </TouchableOpacity>
                ...
                <View style={styles.signUpContainer}>
                    <Text style={styles.txt}>{t('noAccount')} ?</Text>
                    <TouchableOpacity style={styles.btnSignUp}>
                        <Text style={styles.txtSignUp}>{t('singup')}</Text>
                    </TouchableOpacity>
                </View>

                <View style={styles.loginOtherContainer}>
                    <View style={styles.line}></View>
                    <Text style={[styles.txt, styles.txtLoginOther]}>{t('loginOtherWay')}</Text>
                    <View style={styles.line}></View>
                </View>

                <View>
                    <TouchableOpacity
                        style={[styles.btnLoginOther, { backgroundColor: '#3F60B2' }]}
                    >
                        <View style={styles.containerIcFB}>
                            ...
                            >
                                <Path
                                    d="M11.1089 25.4772H14.8119V16.1345H17.9082L18.3758 12.4998H14.8119V10.1705C14.8119 9.12104 15.1025 8.40434 16.5938 8.40434H18.5021V5.14078C18.1736 5.10239 17.0488 5 15.7344 5C12.9794 5 11.1089 6.70217 11.1089 9.81214V12.4998H8V16.1345H11.1089V25.4772Z"
                                    fill="#3F60B2"
                                />
                            </Svg>
                        </View>
                        <Text style={styles.txtLoginOtherPath}>{t('loginWith')} Facebook</Text>
                    </TouchableOpacity>

                    <TouchableOpacity
                        style={[styles.btnLoginOther, { backgroundColor: '#131416' }]}
                    >
